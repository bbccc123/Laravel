            ...
            <form id="orderForm" action="<?php echo e(route('order')); ?>" method="POST">
                ...
                <div class="col-md-6">
                    <div class="billing-details" style="border-top: 1px solid #ccc">
                        ...
                        <div class="form-group">
                            <input class="input" type="text" name="address" placeholder="Địa chỉ nhận hàng" value="<?php echo e(Auth::user()->address); ?>" required>
                        </div>
                        <h5>Số điện thoại*</h5>
                        <div class="form-group">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\duyho\Desktop\Nhóm 4 - Xây dựng website bán thức ăn trực tuyến\TLCN_Laravel\resources\views/checkout.blade.php ENDPATH**/ ?>