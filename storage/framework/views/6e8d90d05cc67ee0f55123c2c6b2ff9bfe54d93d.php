            ...
            <div class="card h-auto">
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-center links">
                        Bạn muốn trở lại trang đăng nhập?<a href="<?php echo e(route('login')); ?>">Quay lại</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layout.applogin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vol17_2/infinityfree.com/if0_35580029/htdocs/resources/views/login/reset-password.blade.php ENDPATH**/ ?>