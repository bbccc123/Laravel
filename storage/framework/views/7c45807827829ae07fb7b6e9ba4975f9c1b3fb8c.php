                        ...
                        <div class="order-summary">
                            <div class="order-products">
                                ...
                                <div class="order-col">
                                    ...
                                    <?php
                                    $ship = (Session::get('Cart')->totalPrice > 300000) ? 0 : 30000;
                                ?>
                                            ...
                                            <?php if($cou['coupon_remain'] > 0): ?>
                                                <?php if($cou['min_order'] < Session::get('Cart')->totalPrice): ?>
                                                    ...
                                                    <div class="order-col" style="margin-top:12px">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div><strong><?php echo e(number_format(-$total_coupon, 0, ',', '.')); ?> đ</strong></div>
                                                ...
                                                <?php else: ?>
                                                    <div class="alert alert-danger">Giá trị đơn hàng chưa đáp ứng, tối thiểu là:
                                                        <span style="font-weight: 700;"><?php echo e(number_format($cou['min_order'], 0, ',', '.')); ?>
                                ...
                                <h4 class="order-col" style="margin-bottom: 30px">
                                    <div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vol17_2/infinityfree.com/if0_35580029/htdocs/laravel/resources/views/checkout.blade.php ENDPATH**/ ?>