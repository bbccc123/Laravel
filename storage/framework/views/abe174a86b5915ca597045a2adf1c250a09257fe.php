            ...
            <div class="row">
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="footer">
                        ...
                        <ul class="footer-links">
                            <li><a href="<?php echo e(route('products', ['type_id' => 1])); ?>"><strong>Trái cây</strong></a></li>
                            <li><a href="<?php echo e(route('products', ['type_id' => 2])); ?>"><strong>Bánh ngọt</strong></a></li>
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="footer">
                        ...
                        <ul class="footer-links">
                            <?php if(Auth::check()): ?>
                                <li><a href="<?php echo e(route('profile', ['user_id' => Auth::user()->user_id])); ?>">Tài Khoản Của Tôi</a></li>
                            <?php endif; ?>
...
</html><?php /**PATH /home/vol17_2/infinityfree.com/if0_35580029/htdocs/laravel/resources/views/layout/footer.blade.php ENDPATH**/ ?>