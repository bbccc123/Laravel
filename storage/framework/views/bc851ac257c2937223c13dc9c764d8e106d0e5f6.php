    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="<?php echo e(asset('assets/img/' . Auth::user()->image)); ?>" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
                    <a href="/admin/users" class="d-block"><?php echo e(Auth::user()->First_name); ?> <?php echo e(Auth::user()->Last_name); ?></a>
                </div>
            </div>
...
<?php /**PATH /home/vol17_2/infinityfree.com/if0_35580029/htdocs/laravel/resources/views/layout/adminheader.blade.php ENDPATH**/ ?>