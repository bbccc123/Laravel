    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                @foreach ($typebyid as $value)
                    <form action="/admin/protypes/{{ $value->type_id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input readonly value="{{ $value->type_id }}" type="text" id="inputID"
                                                class="form-control" name="type_id">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputName">Type_Name</label>
                                            <input value="{{ $value->type_name }}" type="text" id="inputName"
